...
const characterProfiles = [
  ["Jason Duval", "ジェイソン・デュバル", `<p>ジェイソン・デュバル</p><h4>公式に確認できる経歴</h4><p>ジェイソンは、詐欺師や犯罪者が身近にいる環境で育ちました。問題の多かった10代の生活から抜け出そうと陸軍に入ったものの、その後はレオナイダ・キーズで地元の麻薬密輸業者の仕事をしています。</p><p>本人は平穏で簡単な生活を望んでいますが、現実には状況が悪化し続けています。</p><h4>Luciaとの関係</h4><p>公式紹介では、ルシアとの出会いがジェイソンの人生で「最高の出来事」にも「最悪の出来事」にもなり得ると表現されています。</p><p>ジェイソンはルシアに対して強い忠誠心を示しており、トレーラーでも二人が恋愛関係と犯罪上の相棒を兼ねていることが分かります。ただし、結婚している、婚約しているといった具体的な関係は公表されていません。</p><h4>周辺人物との関係</h4><p>ジェイソンは、Brian Hederが所有する物件に家賃なしで住んでいます。その代わり、地元での取り立てなど、Brianの仕事を手伝う必要があります。</p><p>Cal Hamptonはジェイソンの友人であり、Brianの仕事仲間でもあります。</p>`],
  ["Lucia Caminos", "ルシア・カミノス", `<p>ルシア・カミノス</p><h4>公式に確認できる経歴</h4><p>ルシアは、幼いころから父親に戦い方を教えられて育ちました。家族を守るために起こした行動によって、レオナイダ刑務所へ収監されています。</p><p>刑務所から出られたのは、公式説明では本人の実力というより「幸運」によるものとされています。出所後は、無計画な行動を避け、より計算された方法で人生を変えようとしています。</p><h4>目的</h4><p>ルシアが望んでいるのは、母親がかつて夢見ていた「豊かで安定した生活」です。</p><p>ルシアと母親は以前、Liberty Cityで暮らしていたことが公式に示されています。ただし、ルシアがLiberty City生まれなのか、何歳まで住んでいたのかは分かっていません。</p><h4>Jasonとの関係</h4><p>公式プロフィールには、ジェイソンとの生活がルシアにとって現在の状況から抜け出す手段になり得ると書かれています。</p><p>そのためルシアは、単にジェイソンに付き従う人物ではなく、自分の計画を持ち、ジェイソンとの関係もその将来設計の一部として考えている人物と読み取れます。</p>`],
  ["Cal Hampton", "カル・ハンプトン", `<p>カル・ハンプトン</p><p>Calはジェイソンの友人で、Brianの仕事仲間です。</p><p>自宅でビールを飲みながら沿岸警備隊の無線を傍受し、インターネット上の陰謀論を追いかけることを好みます。鳥が不自然な隊列で飛んでいることを疑うなど、かなり強い被害妄想・陰謀論的思考を持つ人物として描かれています。</p><p>Cal本人は現在の停滞した暮らしに満足していますが、ジェイソンはそこから抜け出そうとしています。二人の方向性の違いが、物語上の対立や別離につながる可能性があります。ただし、後半部分は公式設定からの推測です。</p>`],
  ["Boobie Ike", "ブービー・アイク", `<p>ブービー・アイク</p><p>BoobieはVice Cityで知られた地元の有力者です。</p><p>路上犯罪の世界で得た地位や資金を利用し、現在は次の事業を運営しています。</p><ul><li>不動産</li><li>ストリップクラブ</li><li>レコーディングスタジオ</li></ul><p>普段は笑顔で人当たりよく振る舞う一方、仕事の話になると態度が変わる人物です。合法的な事業だけでなく、麻薬取引による資金が事業全体を支えていることも、本人の発言から示されています。</p><h4>Dre'Quanとの関係</h4><p>Boobieが特に力を入れているのが、Dre'Quan Priestと組んで展開するOnly Raw Recordsです。</p><p>クラブとスタジオは用意できていますが、レーベルを成功させるための大ヒット曲がまだ不足しています。</p>`],
  ["Dre'Quan Priest", "ドレクアン・プリースト", `<p>ドレクアン・プリースト</p><p>Dre'Quanは、ギャングというよりも商才のあるハスラーとして紹介されています。</p><p>生活費を稼ぐために路上で麻薬を売っていた時期もありますが、本来の目標は音楽業界で成功することでした。Boobieのストリップクラブで出演者を手配しながら、レコード会社の立ち上げを進めています。</p><h4>Real Dimezとの関係</h4><p>Dre'QuanはReal Dimezと契約しました。</p><p>この契約をきっかけに、クラブ内の小規模な仕事から離れ、Vice City全体の音楽シーンへ進出しようとしています。物語では、Boobieの資金力とDre'Quanの音楽ビジネス、Real Dimezの知名度が一つの勢力として描かれる可能性があります。</p>`],
  ["Real Dimez", "リアル・ダイムズ", `<p>リアル・ダイムズ</p><p>Real Dimezは一人の人物ではなく、次の女性2人によるラップデュオです。</p><ul><li>Bae-Luxe</li><li>Roxy</li></ul><p>二人は高校時代からの友人です。以前は地元の麻薬売人から金品を奪っていましたが、その経験や知名度を、刺激的なラップ曲と積極的なSNS活動へ転換しました。</p><h4>音楽活動</h4><p>地元ラッパーのDWNPLYと発表した初期のヒット曲によって、一度は注目を集めています。</p><p>しかし、その後の5年間には多くの問題があり、現在はOnly Raw Recordsと契約して再起を狙っています。公式には「次のヒットまであと一歩」という立場です。</p><p>SNS、クラブ、音楽、犯罪が結びついた現代的なVice Cityを象徴する人物群と考えられます。</p>`],
  ["Raul Bautista", "ラウル・バウティスタ", `<p>ラウル・バウティスタ</p><p>Raulは経験豊富な銀行強盗です。</p><p>自信、魅力、狡猾さを持ち、高額な報酬を得るために危険を冒せる人材を常に探しています。状況に合わせて行動を変えるプロ意識を持つ一方、本人の無謀さによって、仕事を重ねるほど危険度が高くなる人物です。</p><h4>JasonとLuciaとの関係</h4><p>公式プロフィールでは、Raulがジェイソンやルシアと直接どのように知り合うのかまでは説明されていません。</p><p>ただし、彼が銀行強盗のための人材を探していることから、二人を小規模犯罪から大規模な強盗へ導く役割を担う可能性があります。これは公式経歴とトレーラーの構成をもとにした推測であり、確定情報ではありません。</p>`],
  ["Brian Heder", "ブライアン・ヘダー", `<p>ブライアン・ヘダー</p><p>Brianは、レオナイダ・キーズにおける昔ながらの麻薬密輸業者です。</p><p>密輸が盛んだった時代から活動しており、現在も3人目の妻Loriとともに、所有するボートヤードを使って商品を運んでいます。長年生き残ってきたため、自分で危険な作業をするよりも、ほかの人間に実行させる立場になっています。</p><h4>Jasonとの関係</h4><p>Brianはジェイソンに物件を無償で貸しています。</p><p>ただし完全な好意ではなく、ジェイソンが地元での取り立てや脅しの仕事を手伝うことが条件です。ジェイソンにとっては住居を提供する恩人である一方、犯罪生活から抜け出せなくしている雇い主でもあります。</p>`],
];

const characterAccordions = () => `<div class="seo-character-list">${characterProfiles.map(([name, note, detailHtml], index) => `<details class="seo-character"><summary><span>${String(index + 1).padStart(2, "0")}</span><span><strong>${esc(name)}</strong><small>${esc(note)}</small></span><i aria-hidden="true">›</i></summary><div>${detailHtml}<a href="https://www.rockstargames.com/VI/only-in-leonida" target="_blank" rel="noopener noreferrer">公式People &amp; Placesで確認する ↗</a></div></details>`).join("")}</div>`;
...
<section><h2>関連情報</h2>${cards([["/official/","公式発表","一次情報を確認"],["/systems/","ゲームシステム","車両を含むシステム情報"],["/map/","舞台・地域","車両が登場する地域"]])}</section>`
  ...
  },
  {
    ...
    body: `<section><h2>担当する作業</h2><ul class="seo-list"><li>Rockstar Gamesなどの一次情報を確認する</li><li>公式情報、報道、未確認情報、リーク、考察を分類する</li><li>英語原文と日本語記事の固有名詞・日付・数値を照合する</li><li>公開後に公式発表が変わった場合は本文を更新する</li></ul></section><section><h2>公開している運営情報</h2><dl class="seo-table"><div><dt>運営形態</dt><dd>個人運営</dd></div><div><dt>執筆・確認名義</dt><dd>GTA6インフォ編集部</dd></div><div><dt>実名</dt><dd>非公開</dd></div><div><dt>プレイ歴・使用機種</dt><dd>GTA2〜GTA5／PlayStationシリーズ・PC</dd></div></dl></section><section><h2>訂正について</h2><p>誤りを確認した場合の対応は<a href="/corrections/">訂正・更新方針</a>に従います。訂正依頼と権利関係の連絡先は<a href="/contact/">お問い合わせ</a>で案内します。</p></section>`
  }
];
