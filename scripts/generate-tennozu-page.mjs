...
function hotelCard(hotel, index) {
  return `<article id="${hotel.id}" class="hotel-card">
    <div class="hotel-main">
      <div class="hotel-image-placeholder" aria-label="${escapeHtml(hotel.name)}の外観画像枠">外観画像準備中</div>
    ...
    <div class="hotel-actions">
      <div class="hotel-image-placeholder action-image" aria-label="${escapeHtml(hotel.name)}の外観画像枠">外観画像準備中</div>
