...
function mobilePickCard(pick) {
  ...
  return `<article class="mobile-pick-card">
    ...
    <a class="primary-cta external-link" href="${searchUrl(hotel)}" target="_blank" rel="noopener noreferrer">空室・料金を見る <span aria-hidden="true">↗</span></a>
